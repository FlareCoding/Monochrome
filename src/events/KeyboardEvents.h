...
namespace mc {
    enum class KeyCode {
        ...
        KEY_BACKSPACE, KEY_SPACE, KEY_BACKTICK, KEY_RETURN, KEY_ENTER = KEY_RETURN, KEY_CAPSLOCK,
        KEY_TAB, KEY_LSHIFT, KEY_RSHIFT, KEY_LCONTROL, KEY_RCONTROL, KEY_ALT, KEY_OPTION,

        KEY_UP, KEY_DOWN, KEY_RIGHT, KEY_LEFT,
        KEY_MINUS, KEY_EQUALS, KEY_COMMA, KEY_PERIOD, KEY_SEMICOLON, KEY_TICK,
        KEY_SQUARE_BRACKET_RIGHT, KEY_SQUARE_BRACKET_LEFT, KEY_BACKSLASH, KEY_SLASH
    };
