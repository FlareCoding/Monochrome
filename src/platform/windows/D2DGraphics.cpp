...
namespace mc {
    ...
    void D2DGraphics::initialize() {
        ...
        HRESULT result = D2D1CreateFactory(
            D2D1_FACTORY_TYPE_MULTI_THREADED, s_D2DFactory.GetAddressOf()
        );
        ...
        result = DWriteCreateFactory(
            ...
            reinterpret_cast<IUnknown**>(s_writeFactory.GetAddressOf())
        );
        ...
        result = CoCreateInstance(
            ...
            reinterpret_cast<LPVOID*>(s_wicImagingFactory.GetAddressOf())
        );
    ...
    ComPtr<ID2D1BitmapRenderTarget> D2DGraphics::createBitmapRenderTarget(
        ...
        HRESULT result =
            hwndRenderTarget->CreateCompatibleRenderTarget(renderTarget.GetAddressOf());
    ...
    ComPtr<ID2D1Bitmap> D2DGraphics::createBitmap(
        ...
        CORE_ASSERT(
            result == S_OK,
            "Failed to create bitmap, error code: " + std::system_category().message(result)
        );
        return bitmap;
    }
} // namespace mc
